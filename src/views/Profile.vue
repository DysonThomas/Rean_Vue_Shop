                  ...
                  <form>
                    <div class="container mt-5">
                      <div class="row">
                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                            <input type="text" @keyup.enter="pinsearch"  v-model="profile.postCode" placeholder="Pincode (Press Enter Key For Auto Fill)" class="form-control">
                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                              <input type="submit" @click="updateProfile" value="Save Changes" class="btn btn-primary mt-2 w-100">
                          </div>
                           <div class="form-group">
                              <input type="submit" @click="logout" value="Logout" class="btn btn-danger mt-2 w-100">
                          </div>
                        </div>
...
export default {
  ...
  methods:{
    ...
    console.error("Error writing document: ", error);
      ...
      pinsearch(){
       axios.post('https://api.postalpincode.in/pincode/', 
        this.profile.postcode).then(response => (this.info = response))
      }
  },
  // created(){
  //   const user = fb.auth().currentUser;
